...
- [ ] Segue `.claude/skills/karpathy-guidelines/SKILL.md`? (alterações cirúrgicas, sem refatoração não solicitada)
- [ ] Testes cobrem caminho feliz + pelo menos um caso de borda?
- [ ] UI nova/alterada segue `.claude/skills/responsive-design/SKILL.md`?
